...
BOT_TOKEN = "7368389395:AAHF8Gh6Jc6Lnpj4l00iYnEiHtCXH3lL2cg"
...
# ----------------------------------------------------------------------------------
# FALLBACK HANDLER (non-command text) => @Mod_By_Kamal
# ----------------------------------------------------------------------------------
...
def main():
    # Optional: auto-install ChromeDriver if needed @Mod_By_Kamal
    setup_chrome_driver()

    # Build the application with your (valid) bot token @Mod_By_Kamal
    app = ApplicationBuilder().token(BOT_TOKEN).build()

    # Command handlers @Mod_By_Kamal
    ...
    # Fallback for any non-command text => does nothing @Mod_By_Kamal
